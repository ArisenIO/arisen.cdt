...
// Definitions in `arisen.cdt/libraries/arisen/symbol.hpp`
ARISEN_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `arisen.cdt/libraries/arisen/symbol.hpp`
ARISEN_TEST_BEGIN(symbol_type_test)
...
// Definitions in `arisen.cdt/libraries/arisen/symbol.hpp`
ARISEN_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   ARISEN_TEST(symbol_code_type_test);
   ARISEN_TEST(symbol_type_test);
   ARISEN_TEST(extended_symbol_type_test);
   return has_failed();
}
