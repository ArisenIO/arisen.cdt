...
// Defined in `arisen.cdt/libraries/arisen/varint.hpp`
ARISEN_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `arisen.cdt/libraries/arisen/varint.hpp`
ARISEN_TEST_BEGIN(signed_int_type_test)
   //// signed_int(uint32_t)
...
int main(int argc, char* argv[]) {
   ...
   ARISEN_TEST(unsigned_int_type_test)
   ARISEN_TEST(signed_int_type_test);
   return has_failed();
}
