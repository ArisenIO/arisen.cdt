...
struct D1 : public B {
   const int i{};
   RSNLIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   RSNLIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `arisen.cdt/libraries/arisen/serialize.hpp`
ARISEN_TEST_BEGIN(serialize_test)
