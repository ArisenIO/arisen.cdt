...
#include <arisen/rope.hpp>
#include <arisen/tester.hpp>
#include <string>

using namespace arisen::native;

ARISEN_TEST_BEGIN(rope_test)
   arisen::rope r("test string 0");
   r += ", test string 1";
   r += ", test string 2";
   r += ", test string 3";
   r += ", test string 4";
   ...
   arisen::rope r2 = r + arisen::rope("lhs") + arisen::rope("rhs") + "some string";
   std::string s2 = s + std::string("lhs") + std::string("rhs") + "some string";

   r2 += arisen::rope("rvalue +=");
