...
// Definitions in `arisen.cdt/libraries/arisen/asset.hpp`
ARISEN_TEST_BEGIN(asset_type_test)
...
// Definitions in `arisen.cdt/libraries/arisen/asset.hpp`
ARISEN_TEST_BEGIN(extended_asset_type_test)
...
int main(int argc, char* argv[]) {
   ...
   ARISEN_TEST(asset_type_test);
   ARISEN_TEST(extended_asset_type_test);
   return has_failed();
}
