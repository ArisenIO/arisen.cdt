...
CONTRACT multi_index_example : public contract {
   public:
      ...
      typedef arisen::multi_index<"testtaba"_n, test_table, arisen::indexed_by<"secid"_n, arisen::const_mem_fun<test_table, uint64_t, &test_table::by_secondary>>> test_tables;
