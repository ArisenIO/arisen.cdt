...
def main():
    ...
    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            ...
            print('Usage: ./ricardeos.py import /rsn/contracts/contract/mycontract.abi /rsn/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricardeos.py export /rsn/contracts/contract/mycontract.abi')
