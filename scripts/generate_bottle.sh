...
mkdir -p ${PROJECT}/${VERSION}/opt/arisen_cdt/lib/cmake
...
echo "class ArisenCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/arisenio/arisen.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/arisenio/arisen.cdt/releases/download/v${VERSION}\"
