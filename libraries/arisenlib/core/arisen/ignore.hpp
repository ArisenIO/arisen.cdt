...
namespace arisen {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::arisen::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::arisen::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::arisen::ignore<T>&) {
     return ds;
   }
}
