...
#warning "<arisenlib/symbol.hpp> is deprecated use <arisen/symbol.hpp>"
namespace arisen {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const arisen::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, arisen::symbol_code& sym_code) {
         uint64_t raw = 0;
