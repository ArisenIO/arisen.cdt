 ...
 */
#include "core/arisen/crypto.hpp"
...
namespace arisen {
   ...
   arisen::public_key recover_key( const arisen::checksum256& digest, const arisen::signature& sig ) {
      ...
      char sig_data[70];
      arisen::datastream<char*> sig_ds( sig_data, sizeof(sig_data) );
      ...
      arisen::datastream<char*> pubkey_ds( pubkey_data, pubkey_size );
      arisen::public_key pubkey;
      pubkey_ds >> pubkey;
      return pubkey;
   }
   ...
   void assert_recover_key( const arisen::checksum256& digest, const arisen::signature& sig, const arisen::public_key& pubkey ) {
      ...
      char pubkey_data[38];
      arisen::datastream<char*> pubkey_ds( pubkey_data, sizeof(pubkey_data) );
