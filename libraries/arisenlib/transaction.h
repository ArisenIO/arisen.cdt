...
#warning "<arisenlib/transaction.h> is deprecated use <arisen/transaction.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
extern "C" {
   /**
