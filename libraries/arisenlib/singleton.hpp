...
#warning "<arisenlib/singleton.hpp> is deprecated use <arisen/singleton.hpp>"
namespace  arisen {

   /**
    *  @defgroup singleton Singleton Table
    *  @ingroup contracts
    *  @brief Defines ARISEN Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      public:
         ...
         T get() {
            ...
            arisen::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
