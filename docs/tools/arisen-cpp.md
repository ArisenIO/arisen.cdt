### Usage
---
To manually compile the source code, use `arisen-cpp/arisen-cc` and `arisen-ld` as if it were __clang__ and __lld__. All the includes and options specific to ARISEN and CDT are baked in.

###$ arisen-cpp
---
```
USAGE: arisen-cpp [options] <input file> ...
