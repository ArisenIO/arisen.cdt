if(ARISEN_CDT_ROOT STREQUAL "" OR NOT ARISEN_CDT_ROOT)
   set(ARISEN_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${ARISEN_CDT_ROOT}/lib/cmake/arisen.cdt)
if (NOT ARISEN_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(ARISEN_WASM_OLD_BEHAVIOR "On")
    include(ArisenWasmToolchain)
endif()
...
function(ARISEN_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(ARISEN_CHECK_VERSION)
